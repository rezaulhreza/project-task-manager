...
<head>
    ...
    <title>Vue Js Email Verify</title>
</head>
<body>
<td class="esd-stripe" align="center">
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <tr>
                                    <td align="center" class="esd-block-button es-p10t es-p10b es-m-txt-l">
												<span style="background: #ffffff;"><a href="http://127.0.0.1:8000/verify-email/{{ $key }}"  target="_blank" style="background-color: #4CAF50; /* Green */
  border: none;
  color: white;
  padding: 15px 32px;
  text-align: center;
  ...
  font-size: 16px; ">Verify my email</a></span>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
